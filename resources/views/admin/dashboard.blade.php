...
@section('title', 'SIMALAM - Dashboard Admin')
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="fw-bold mb-0" style="font-size:1.35rem; letter-spacing:-0.3px; color:var(--dark);">
                    {{ $isSuperAdmin ? 'Dashboard Super Admin SIMALAM' : 'Dashboard Admin SIMALAM' }}
                </h1>
                <p class="mb-0 text-muted" style="font-size:0.85rem;">
                    {{ $isSuperAdmin ? 'Akses penuh Sistem Informasi Monitoring Absensi dan Laporan Magang' : 'Kelola peserta magang, absensi, laporan, dan sertifikat' }}
                </p>
